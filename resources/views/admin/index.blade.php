...
<!DOCTYPE html>
<head>
    <title>Admin Education Online</title>
    <base href="{{asset('')}}">
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu extended logout">
                        <li><a href="admin/info/{{Session::get('admin_id')}}"><i class=" fa fa-suitcase"></i> Thông tin admin</a></li>
                        <li><a href="admin/edit/{{Session::get('admin_id')}}"><i class="fa fa-cog"></i> Sửa tài khoản</a></li>
