        ...
        <div class="row">
            ...
            <div class="col-sm-5 col-sm-offset-1">
                <div class="login-form"><!--login form-->
                    <h2 style="font-weight: bold">Xác nhận xóa tài khoản người dùng</h2>
                    ...
                    @endif
                    <form action="page/xoataikhoan" method="post" name="myForm" >
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tên người dùng</label>
                            <input type="text" style="font-weight: bold; color: #888888; font-size: 18px; padding-left: 20px" placeholder="Nhâp tên người dùng" name="name" disabled value="{{$nguoidung->name}}" />
                        </div>
                        <div class="form-group">
                        ...
                        <table>
                            <tr>
                                <td ><input type="submit" id="btn_submit" class="btn btn-default " value="Xóa tài khoản"style="color: white; background-color: #fe980f; border: solid; font-weight: bold;margin-top: 22px; padding-left: 30px; padding-right: 30px;"></input></td>
